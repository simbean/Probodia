package com.probodia.foodservice.api.aspect;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.probodia.foodservice.api.controller..*.*(..))")
    ...
    @Pointcut("execution(* com.probodia.foodservice.api.service..*.*(..))")
    ...
    @Around("@annotation(com.probodia.foodservice.api.annotation.BasicError)")
    ...
    @Around("@annotation(com.probodia.foodservice.api.annotation.ValidationError)")
